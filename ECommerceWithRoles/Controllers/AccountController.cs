...
namespace ECommerceWithRoles.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.UserName, Email = model.Email, ShoppingBasket = new ShoppingBasket() };
        ...
        [ValidateAntiForgeryToken]
        [HttpPost]
        public async Task<ActionResult> LoginWithTestAccount(string returnUrl)
        {
            var userName = "admin";
